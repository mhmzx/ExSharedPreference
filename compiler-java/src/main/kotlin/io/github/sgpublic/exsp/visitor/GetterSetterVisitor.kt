...
import io.github.sgpublic.exsp.base.SimpleElementVisitor
import io.github.sgpublic.exsp.base.SingleElementVisitor
import io.github.sgpublic.exsp.core.ConverterCompiler
import io.github.sgpublic.exsp.jc.Modifiers
    ...
    override fun visitVariable(element: VariableElement, param: ExValue): JCMethodDecl {
        ...
        if (element.isEnum()) {
            ...
            conType = ClassName.get(ConverterCompiler.getTarget(
                ExPreferenceProcessor.asElement(element.asType())!!
            ))
        }
